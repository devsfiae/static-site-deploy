...
<html>
<head>
    <title>Speisen@La Mediterranea</title>
    <style>
* {
...
<?php
    ...
    for ($categoryId = 7; $categoryId <= 10; $categoryId++) {
        ...
        if ($result->num_rows > 0) {
            ...
            do {
                $rounded_price = round($row["menu_price"], 2);
                $formatted_price = str_replace('.', ',', $rounded_price);
                echo "<p>#". $row["menu_id"]. " " . $row["menu_name"]. "<br>";
                echo $row["menu_ingredients"]. "<br>";
